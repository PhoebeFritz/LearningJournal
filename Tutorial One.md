...
Lately, you may also need to manually add a camera which can be done by right clicking the hierarchy menu again and going down to camera. Selecting this ill add in a camera into your scene. From here you need to move the camera into position and rotating it on the desired axis to get an angle if desired. 
